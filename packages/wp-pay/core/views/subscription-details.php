...
$details = [
	[
		'term'        => __( 'Description', 'pronamic-pay-with-mollie-for-gravity-forms' ),
...
if ( null !== $phase ) {
	// Amount.
	$details[] = [
		'term'        => __( 'Amount', 'pronamic-pay-with-mollie-for-gravity-forms' ),
...
if ( ! empty( $payment_method ) ) {
	$details[] = [
		'term'        => __( 'Payment method', 'pronamic-pay-with-mollie-for-gravity-forms' ),
...
// Recurrence.
$details[] = [
	'term'        => __( 'Recurrence', 'pronamic-pay-with-mollie-for-gravity-forms' ),
	'description' => $recurrence,
];

?>

<h2><?php esc_html_e( 'Subscription', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></h2>
