...
if ( 0 === count( $payments ) ) : ?>
	...
	<?php esc_html_e( 'No payments found.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
...
<?php else : ?>
	...
	<table class="pronamic-pay-table widefat">
		<thead>
			<tr>
				<th scope="col">
					<span class="pronamic-pay-tip pronamic-pay-icon pronamic-pay-status" title="<?php esc_attr_e( 'Status', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>"><?php esc_html_e( 'Status', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></span>
				</th>
				<th scope="col"><?php esc_html_e( 'Period', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></th>
				<th scope="col"><?php esc_html_e( 'Payment', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></th>
				<th scope="col"><?php esc_html_e( 'Transaction', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></th>
				<th scope="col"><?php esc_html_e( 'Amount', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></th>
				<th scope="col"><?php esc_html_e( 'Date', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></th>
			</tr>
		</thead>
						...
						if ( in_array( $subscription->get_source(), [ 'woocommerce' ], true ) && null !== $next_payment_date ) :
							...
							echo wp_kses_post(
								sprintf(
									...
									__( 'Will be created on %s', 'pronamic-pay-with-mollie-for-gravity-forms' ),
									\esc_html( $next_payment_date->format_i18n( __( 'D j M Y', 'pronamic-pay-with-mollie-for-gravity-forms' ) ) )
								)
							);
						...
						elseif ( null !== $next_payment_delivery_date ) :
							...
							echo wp_kses_post(
								sprintf(
									...
									__( 'Will be created on %1$s or %2$s', 'pronamic-pay-with-mollie-for-gravity-forms' ),
									\esc_html( $next_payment_delivery_date->format_i18n( __( 'D j M Y', 'pronamic-pay-with-mollie-for-gravity-forms' ) ) ),
									\sprintf(
										'<a href="%1$s">%2$s</a>',
										\esc_url( $create_next_payment_url ),
										\esc_html( \__( 'create now', 'pronamic-pay-with-mollie-for-gravity-forms' ) )
									)
								)
							);
								...
								\printf(
									...
									\esc_html(
										sprintf(
											...
											__( 'Retry payment #%d', 'pronamic-pay-with-mollie-for-gravity-forms' ),
											$payment_id
										)
									)
								);
