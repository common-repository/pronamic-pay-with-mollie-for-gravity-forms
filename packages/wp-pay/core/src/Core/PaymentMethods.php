...
class PaymentMethods {
	...
	public static function get_payment_methods() {
		$payment_methods = [
			self::AFTERPAY_NL             => _x( 'AfterPay', 'afterpay.nl', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::AFTERPAY_COM            => _x( 'Afterpay', 'afterpay.com', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::ALIPAY                  => __( 'Alipay', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::AMERICAN_EXPRESS        => __( 'American Express', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::APPLE_PAY               => __( 'Apple Pay', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::BANCONTACT              => __( 'Bancontact', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::BANK_TRANSFER           => __( 'Bank Transfer', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::BELFIUS                 => __( 'Belfius Direct Net', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::BILLIE                  => __( 'Billie', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::BILLINK                 => __( 'Billink', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::BITCOIN                 => __( 'Bitcoin', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::BLIK                    => __( 'BLIK', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::BUNQ                    => __( 'Bunq', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::CAPAYABLE               => __( 'Capayable', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::IN3                     => __( 'In3', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::CARD                    => __( 'Card', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::CREDIT_CARD             => __( 'Credit Card', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::DIRECT_DEBIT            => __( 'Direct Debit', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::DIRECT_DEBIT_BANCONTACT => sprintf(
				/* translators: %s: payment method */
				__( 'Direct Debit (mandate via %s)', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				__( 'Bancontact', 'pronamic-pay-with-mollie-for-gravity-forms' )
			),
			self::DIRECT_DEBIT_IDEAL      => sprintf(
				/* translators: %s: payment method */
				__( 'Direct Debit (mandate via %s)', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				__( 'iDEAL', 'pronamic-pay-with-mollie-for-gravity-forms' )
			),
			self::DIRECT_DEBIT_SOFORT     => sprintf(
				/* translators: %s: payment method */
				__( 'Direct Debit (mandate via %s)', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				__( 'SOFORT', 'pronamic-pay-with-mollie-for-gravity-forms' )
			),
			self::EPS                     => __( 'EPS', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::FOCUM                   => __( 'Focum', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::GIROPAY                 => __( 'Giropay', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::GOOGLE_PAY              => __( 'Google Pay', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::IDEAL                   => __( 'iDEAL', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::IDEALQR                 => __( 'iDEAL QR', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::KBC                     => __( 'KBC/CBC Payment Button', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::KLARNA_PAY_LATER        => __( 'Klarna Pay Later', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::KLARNA_PAY_NOW          => __( 'Klarna Pay Now', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::KLARNA_PAY_OVER_TIME    => __( 'Klarna Pay Over Time', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::MAESTRO                 => __( 'Maestro', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::MASTERCARD              => __( 'Mastercard', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::MB_WAY                  => __( 'MB WAY', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::MOBILEPAY               => __( 'MobilePay', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::PAYCONIQ                => __( 'Payconiq', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::PAYPAL                  => __( 'PayPal', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::PRZELEWY24              => __( 'Przelewy24', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::RIVERTY                 => __( 'Riverty', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::SANTANDER               => __( 'Santander', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::SOFORT                  => __( 'SOFORT Banking', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::SPRAYPAY                => __( 'SprayPay', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::SWISH                   => __( 'Swish', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::TWINT                   => __( 'TWINT', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::V_PAY                   => __( 'V PAY', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::VIPPS                   => __( 'Vipps', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			self::VISA                    => __( 'Visa', 'pronamic-pay-with-mollie-for-gravity-forms' ),
		];
