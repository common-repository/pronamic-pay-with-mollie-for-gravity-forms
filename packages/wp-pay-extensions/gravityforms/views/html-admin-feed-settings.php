...
<div id="gf-pay-feed-editor">
	...
	<div class="pronamic-pay-tabs">
		...
		<ul class="pronamic-pay-tabs-items">
			<li><?php esc_html_e( 'General', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></li>
			<li><?php esc_html_e( 'Status pages', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></li>
			<li><?php esc_html_e( 'Subscription', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></li>
			<li><?php esc_html_e( 'Fields', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></li>
			<li><?php esc_html_e( 'Advanced', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></li>
		</ul>
		...
		<div class="pronamic-pay-tab">
			...
			<table class="pronamic-pay-table-striped form-table">
				<tr>
					<th scope="row">
						<label for="_pronamic_pay_gf_config_id">
							<?php esc_html_e( 'Configuration', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</label>

						<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php esc_attr_e( 'Gateway configuration, created via <strong>Pay » Configurations</strong>.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>"></span>
					</th>
					<td>
						<?php
				...
				<tr>
					<th scope="row">
						<label for="_pronamic_pay_gf_order_id">
							<?php esc_html_e( 'Order ID', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</label>

						<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php esc_attr_e( 'Order ID.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>"></span>
					</th>
					<td>
						...
						<span class="description pronamic-pay-description">
							...
							echo wp_kses(
								sprintf(
									'%s %s',
									__( 'Default:', 'pronamic-pay-with-mollie-for-gravity-forms' ),
									sprintf(
										'<code>%s</code>',
										'{entry_id}'
									)
							...
							echo wp_kses(
								sprintf(
									'%s %s',
									__( 'Available tags:', 'pronamic-pay-with-mollie-for-gravity-forms' ),
									sprintf(
							...
							<?php esc_html_e( 'An order ID makes it easier to match payments from transaction overviews to a form and is required by some payment providers.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</span>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="_pronamic_pay_gf_transaction_description">
							<?php esc_html_e( 'Transaction Description', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</label>

						<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php esc_attr_e( 'Transaction description that will be send with the payment. Use tags to customize the description.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>"></span>
					</th>
					<td>
						<?php
						...
						<span class="description pronamic-pay-description">
							...
							<?php esc_html_e( 'A description which uses tags and results in more than 32 characters will be truncated.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</span>
					</td>
				</tr>
				...
				if ( count( $notifications ) > 0 ) :
					...
					<tr>
						<th scope="row">
							<?php esc_html_e( 'Send Notifications Delay', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>

							<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php esc_attr_e( 'Notifications for which sending will be delayed until the payment has been received.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>"></span>
						</th>
						<td>
							<p>
								<?php esc_html_e( 'Delay sending notifications until payment has been received.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
							</p>
				...
				<tr>
					<th scope="row">
						<?php esc_html_e( 'Delay actions', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>

						<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php esc_attr_e( 'Actions for which execution will be delayed until the payment has been received.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>"></span>
					</th>
					<td>
						<p>
							<?php esc_html_e( 'Delay actions until payment has been received.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</p>
						...
						<ul>
							<li>
								...
								<label for="_pronamic_pay_gf_delay_post_creation">
									<?php esc_html_e( 'Creating a post', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
								</label>
							</li>
		...
		<div class="pronamic-pay-tab">
			<div class="pronamic-pay-tab-block">
				<?php esc_html_e( 'Set Gravity Forms confirmations, pages or URLs to redirect to after a payment with the mentioned status.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
			</div>
			...
			<table class="pronamic-pay-table-striped form-table pronamic-gf-links-tab">
				...
				$fields = [
					Links::SUCCESS => __( 'Success', 'pronamic-pay-with-mollie-for-gravity-forms' ),
					Links::CANCEL  => __( 'Cancelled', 'pronamic-pay-with-mollie-for-gravity-forms' ),
					Links::EXPIRED => __( 'Expired', 'pronamic-pay-with-mollie-for-gravity-forms' ),
					Links::ERROR   => __( 'Error', 'pronamic-pay-with-mollie-for-gravity-forms' ),
					Links::OPEN    => __( 'Open', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				];
								...
								<ul style="margin: 0;">
									<li style="margin: 0;">
										<label>
											...
											<?php esc_html_e( 'Confirmation:', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
										</label>
										...
										printf(
											...
											\esc_html__( '— Select Confirmation —', 'pronamic-pay-with-mollie-for-gravity-forms' )
										);
									...
									<li style="margin: 0;">
										<label>
											...
											<?php esc_html_e( 'Page:', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
										</label>
										...
										wp_dropdown_pages(
											[
												...
												'show_option_none' => esc_html__( '— Select Page —', 'pronamic-pay-with-mollie-for-gravity-forms' ),
											]
										);
									...
									<li style="margin: 0;">
										<label>
											...
											<?php esc_html_e( 'URL:', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
										</label>
		...
		<div class="pronamic-pay-tab">
			<div class="pronamic-pay-tab-block">
				<?php esc_html_e( 'Set the subscription details for recurring payments.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
			</div>
			...
			<table class="pronamic-pay-table-striped form-table pronamic-gf-subscription-tab">
				<tr>
					<th scope="row">
						<label>
							<?php esc_html_e( 'Recurring amount', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</label>
					</th>
					<td>
						<fieldset>
							<legend class="screen-reader-text">
								<span><?php esc_html_e( 'Recurring amount', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></span>
							</legend>
							...
							<ul class="pronamic-pay-gf-form-choice-list">
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_amount_type_none">
										<?php esc_html_e( 'None', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
									</label>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_amount_type_total">
										<?php esc_html_e( 'Total Amount', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
									</label>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_amount_type_field">
										<?php esc_html_e( 'Form Field', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
									</label>
				...
				<tr>
					<th scope="row">
						<label>
							<?php esc_html_e( 'Interval', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</label>
					</th>
					<td>
						<fieldset>
							<legend class="screen-reader-text">
								<span><?php esc_html_e( 'Interval', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></span>
							</legend>
							...
							<ul class="pronamic-pay-gf-form-choice-list">
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_interval_type_fixed">
										<?php esc_html_e( 'Fixed', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
									</label>

									<div class="pronamic-pay-gf-form-choice-checked">
										<?php echo esc_html( _x( 'Every', 'Recurring payment', 'pronamic-pay-with-mollie-for-gravity-forms' ) ); ?>
										...
										<select id="pronamic_pay_gf_subscription_interval_period" name="_pronamic_pay_gf_subscription_interval_period">
											<option value="D" <?php selected( $pay_feed->subscription_interval_period, 'D' ); ?>><?php esc_html_e( 'day(s)', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></option>
											<option value="W" <?php selected( $pay_feed->subscription_interval_period, 'W' ); ?>><?php esc_html_e( 'week(s)', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></option>
											<option value="M" <?php selected( $pay_feed->subscription_interval_period, 'M' ); ?>><?php esc_html_e( 'month(s)', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></option>
											<option value="Y" <?php selected( $pay_feed->subscription_interval_period, 'Y' ); ?>><?php esc_html_e( 'year(s)', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></option>
										</select>
									</div>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<div class="pronamic-pay-gf-form-choice-checked">
										...
										esc_html_e( 'days', 'pronamic-pay-with-mollie-for-gravity-forms' );
										...
										<p class="description pronamic-pay-description">
											...
											esc_html_e( 'Use a field value of 0 days for one-time payments.', 'pronamic-pay-with-mollie-for-gravity-forms' );
				...
				<tr>
					<th scope="row">
						<label>
							<?php esc_html_e( 'Number of Periods', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</label>
					</th>
					<td>
						<fieldset>
							<legend class="screen-reader-text">
								<span><?php esc_html_e( 'Number of Periods', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></span>
							</legend>
							...
							<ul class="pronamic-pay-gf-form-choice-list">
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_frequency_type_unlimited">
										<?php echo esc_html_x( 'Unlimited', 'Recurring payment', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
									</label>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<div class="pronamic-pay-gf-form-choice-checked">
										...
										<?php echo esc_html( _x( 'times', 'Recurring payment', 'pronamic-pay-with-mollie-for-gravity-forms' ) ); ?>
									</div>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<div class="pronamic-pay-gf-form-choice-checked">
										...
										echo esc_html( _x( 'times', 'Recurring payment', 'pronamic-pay-with-mollie-for-gravity-forms' ) );
				...
				<tr>
					<th scope="row">
						<label>
							<?php esc_html_e( 'Trial Period', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</label>
					</th>
					<td>
						<?php
						...
						<fieldset>
							<legend class="screen-reader-text">
								<span><?php esc_html_e( 'Trial Period', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></span>
							</legend>
							...
							<div class="pronamic-pay-gf-form-choice">
								...
								<label for="pronamic_pay_gf_subscription_trial_enabled">
									<?php esc_html_e( 'Enable trial period', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
								</label>

								<div class="pronamic-pay-gf-form-choice-checked">
									<label for="pronamic_pay_gf_subscription_trial_length">
										<?php esc_html_e( 'Length', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
									</label>
									...
									<select id="pronamic_pay_gf_subscription_trial_length_unit" name="_pronamic_pay_gf_subscription_trial_length_unit">
										<option value="D" <?php selected( $trial->length_unit, 'D' ); ?>><?php esc_html_e( 'day(s)', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></option>
										<option value="W" <?php selected( $trial->length_unit, 'W' ); ?>><?php esc_html_e( 'week(s)', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></option>
										<option value="M" <?php selected( $trial->length_unit, 'M' ); ?>><?php esc_html_e( 'month(s)', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></option>
										<option value="Y" <?php selected( $trial->length_unit, 'Y' ); ?>><?php esc_html_e( 'year(s)', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?></option>
									</select>
							...
							<ul class="pronamic-pay-gf-form-choice-list">
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_interval_date_type_payment_date">
										<?php esc_html_e( 'Entry Date', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
									</label>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_interval_date_type_field">
										...
										<span class="pronamic-pay-gf-subscription-interval-date-sync-settings interval-D">
											<?php esc_html_e( 'Not Available', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
										</span>
										...
										<span class="pronamic-pay-gf-subscription-interval-date-sync-settings interval-M">
											...
											echo wp_kses(
												sprintf(
													...
													__( 'On the %s <sup>th</sup> day of the month', 'pronamic-pay-with-mollie-for-gravity-forms' ),
													$select
												),
												$allowed_html
											);
										...
										<span class="pronamic-pay-gf-subscription-interval-date-sync-settings interval-Y">
											...
											echo wp_kses(
												sprintf(
													...
													__( 'On %1$s %2$s', 'pronamic-pay-with-mollie-for-gravity-forms' ),
													$select_monthday,
													$select_month
												),
												$allowed_html
									...
									<div class="pronamic-pay-gf-form-choice-checked">
										...
										<label for="pronamic_pay_gf_subscription_interval_date_prorate">
											...
											esc_html_e( 'Prorate the amount of the alignment period.', 'pronamic-pay-with-mollie-for-gravity-forms' );
		...
		<div class="pronamic-pay-tab">
			<div class="pronamic-pay-tab-block">
				<?php esc_html_e( 'Set corresponding form fields to include user data in the payment data with some payment providers.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
			</div>

			<?php

			$fields = [
				'prefix_name'                => __( 'Prefix Name', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'first_name'                 => __( 'First Name', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'middle_name'                => __( 'Middle Name', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'last_name'                  => __( 'Last Name', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'suffix_name'                => __( 'Suffix Name', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'address1'                   => __( 'Address', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'address2'                   => __( 'Address 2', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'zip'                        => __( 'Zip', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'city'                       => __( 'City', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'state'                      => __( 'State', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'country'                    => __( 'Country', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'telephone_number'           => __( 'Telephone Number', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'email'                      => __( 'Email', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'consumer_bank_details_name' => __( 'Account Holder Name', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'consumer_bank_details_iban' => __( 'Account IBAN', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'company_name'               => __( 'Company Name', 'pronamic-pay-with-mollie-for-gravity-forms' ),
				'vat_number'                 => __( 'VAT Number', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			];
					...
					<tr>
						...
						<td>
							...
							if ( in_array( $name, [ 'prefix_name', 'first_name', 'middle_name', 'last_name', 'suffix_name' ], true ) ) {
								$auto_option_label = __( '— From first name field —', 'pronamic-pay-with-mollie-for-gravity-forms' );
							} elseif ( in_array( $name, [ 'address1', 'address2', 'zip', 'city', 'state', 'country' ], true ) ) {
								$auto_option_label = __( '— From first address field —', 'pronamic-pay-with-mollie-for-gravity-forms' );
							} elseif ( 'telephone_number' === $name ) {
								$auto_option_label = __( '— First phone field —', 'pronamic-pay-with-mollie-for-gravity-forms' );
							} elseif ( 'email' === $name ) {
								$auto_option_label = __( '— First email address field —', 'pronamic-pay-with-mollie-for-gravity-forms' );
							}
		...
		<div class="pronamic-pay-tab">
			<div class="pronamic-pay-tab-block">
				<?php esc_html_e( 'Optional settings for advanced usage only.', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
			</div>
				...
				<tr>
					<th scope="row">
						<label for="gf_ideal_condition_field_id">
							<?php esc_html_e( 'Conditional Logic', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</label>
					</th>
					<td>
						<div id="gf_ideal_condition_config">
							...
							$field = [
								...
								'label' => __( 'Conditional Logic', 'pronamic-pay-with-mollie-for-gravity-forms' ),
								'type'  => 'feed_condition',
							];
						...
						<p class="description pronamic-pay-description">
							<?php esc_html_e( 'Set conditional logic to only use this gateway if the entry matches the condition(s).', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="gf_ideal_user_role_field_id">
							<?php esc_html_e( 'Update user role', 'pronamic-pay-with-mollie-for-gravity-forms' ); ?>
						</label>
					</th>
					<td>
						<?php
						...
						_pronamic_pay_gravityforms_dropdown_input(
							...
							[
								...
								'options'  => [
									'' => \__( '— Select Field —', 'pronamic-pay-with-mollie-for-gravity-forms' ),
								],
							]
						);
