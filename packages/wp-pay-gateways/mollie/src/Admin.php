...
class Admin {
	...
	public function admin_menu() {
		...
		add_menu_page(
			__( 'Mollie', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			__( 'Mollie', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			'manage_options',
			'pronamic_pay_mollie',
			[ $this, 'page_mollie' ],
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Profiles', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			__( 'Profiles', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			'manage_options',
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Customers', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			__( 'Customers', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			'manage_options',
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Mandates', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			__( 'Mandates', 'pronamic-pay-with-mollie-for-gravity-forms' ),
			'manage_options',
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Payments', 'pronamic-pay-with-mollie-for-gravity-forms' ),
